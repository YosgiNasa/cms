	...
	<form action="<?= base_url('Admin/galeri/simpan') ?>" method="post" enctype='multipart/form-data'>
		<div class="card">
			...
			<div class="card-header">
				...
				<label class="col-form-label">Pilih File Dengan 3:4 :</label>
...
<?php foreach($galeri as $ca){ ?>
	<div class="card col-lg-4 col-md-6 col-sm-12 mb-3 mt-3 wow slideInUp" data-wow-delay="0.1s"
		...
		<div class="card-body">
			<img class="img-fluid" src="<?= base_url('assets/upload/galeri/'.$ca['foto']) ?>" alt="">
			<a class="position-absolute top-0 start-0 bg-dark text-white rounded-end mt-5 py-2 px-4"
				href="<?= base_url('assets/upload/galeri/'.$ca['foto']) ?>" target="blank">Lihat foto</a>
			<div class="p-4">
				...
				<p><?= $ca['judul']; ?></p>
				<a class="btn btn-sm mt-3 btn-danger" href="<?= base_url('admin/galeri/hapus_data/'.$ca['foto']);?>"
